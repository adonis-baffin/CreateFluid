...
public class HarpoonRenderer extends EntityRenderer<HarpoonEntity> {
    ...
    public static final ResourceLocation HARPOON_LOCATION = new ResourceLocation(CreateFisheryMod.MODID, "textures/entity/harpoon.png");
    ...
    public void render(HarpoonEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, @NotNull MultiBufferSource buffer, int packedLight) {
        ...
        VertexConsumer vertexconsumer = ItemRenderer.getFoilBuffer(buffer, this.model.renderType(this.getTextureLocation(entity)), false, entity.isFoil());
