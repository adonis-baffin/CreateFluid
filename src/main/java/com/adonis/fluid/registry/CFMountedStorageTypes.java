...
public class CFMountedStorageTypes {
    ...
    public static final RegistryEntry<CopperSinkMountedStorageType> COPPER_SINK =
            simpleFluid("copper_sink", CopperSinkMountedStorageType::new);

    public static final RegistryEntry<GutterOutletMountedStorageType> GUTTER_OUTLET =
