...
public class GutterOutletRenderer extends SmartBlockEntityRenderer<GutterOutletBlockEntity> {
    ...
    private void renderQuad(VertexConsumer builder, PoseStack ms,
        ...
        putVertex(builder, peek, x1, y1, z1, r, g, b, a, minU, minV, light, nx, ny, nz);
        putVertex(builder, peek, x2, y2, z2, r, g, b, a, maxU, minV, light, nx, ny, nz);
        putVertex(builder, peek, x3, y3, z3, r, g, b, a, maxU, maxV, light, nx, ny, nz);
        putVertex(builder, peek, x4, y4, z4, r, g, b, a, minU, maxV, light, nx, ny, nz);
    }

    private void putVertex(VertexConsumer builder, PoseStack.Pose pose, float x, float y, float z,
