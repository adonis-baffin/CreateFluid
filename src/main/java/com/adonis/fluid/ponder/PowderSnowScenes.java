...
//            be.getTankInventory().fill(CFFluid.getPowderSnowFluidStack(2000), IFluidHandler.FluidAction.EXECUTE);
//        });
        scene.idle(20);
        ...
        scene.world().modifyBlockEntity(basinPos, BasinBlockEntity.class, be -> {
            ...
            be.getCapability(ForgeCapabilities.FLUID_HANDLER).ifPresent(fh -> {
                fh.fill(CFFluid.getPowderSnowFluidStack(1000), IFluidHandler.FluidAction.EXECUTE);
            });
        });
        scene.idle(20);
